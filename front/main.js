(function () {
    ...
    ajax.send('id_client=19&cpf_buyer=55372604831&amount_payment=5200.30&type_payment=card&card_name=Leonardo l bufalo&card_number=6011454931724887&card_expiration=1020&card_cvv=345')
    ...
    // ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded')
    // // ajax.send('username=keanu&age=54')
    // ajax.send('cpf_buyer=55372604831&name_buyer=leonardo lemes bufalo&email_buyer=leonardolsbufalo@gmail.com')
    // ajax.onreadystatechange = function (params) {
    //     if (ajax.readyState == 4) {
    //         // console.log( 'usuario cadastrado!', ajax.status )
    //         console.log('Resposta: ' + ajax.response)
